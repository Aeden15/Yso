...
M.crystalism = {
  ...
  retardation = {
    name = "Retardation",
    abadmin_id = 1160,
    syntax = "EMBED RETARDATION <crystal> AT <target> / RECALL RETARDATION / RETRACT RETARDATION",
    shapes = { "disc" },
    works_on = "room",
    cooldown_s = 4.00,
    resource_mana = 300,
    notes = {
      "Slows the very vibrations of the area; can increase equilibrium recovery time and dull reflexes.",
    },
  },
  ...
  cataclysm = {
    name = "Cataclysm",
    abadmin_id = 1314,
    syntax = "VIBRATE CATACLYSM <crystal> <power> / RECALL CATACLYSM / RETRACT CATACLYSM",
    shapes = { "disc", "egg", "polyhedron", "sphere" },
    works_on = "room",
    cooldown_s = 4.00,
    resource_mana = 500,
    notes = {
      "Causes a violent cataclysm in your location, damaging all enemies.",
      "Power tiers (from AB):",
      "  1: pure damage",
      "  2: damage + disrupt",
      "  3: damage + stun",
      "  4: damage + potential broken limbs",
      "  5: strongest; damage + disrupt + stun",
    },
  },
}
