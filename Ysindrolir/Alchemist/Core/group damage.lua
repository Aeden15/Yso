...
local function _class_combo_queue_verb()
  return _queue_verb_name(GD.cfg and GD.cfg.class_combo_queue_verb, "add")
end

local function _instant_kill_queue_verb()
  local verb = _queue_verb_name(GD.cfg and GD.cfg.instant_kill_queue_verb, "addclearfull")
...
function GD.init()
  ...
  GD.cfg.class_combo_queue_verb = _class_combo_queue_verb()
  GD.cfg.instant_kill_queue_verb = _instant_kill_queue_verb()
